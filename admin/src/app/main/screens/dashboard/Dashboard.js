						...
						{!loading && (
							...
							>
								...
								<Card className="widget mx-8 my-8 flex w-full sm:w-1/2 md:w-1/4 p-12">
									<h1>Categories </h1>
									<span>
										<h1 className="text-40">{category && category.payload && category.payload.length}</h1>
								...
								<Card className="widget mx-8 my-8 flex w-full sm:w-1/2 md:w-1/4 p-12">
									<h1>Customers </h1>
									<span>
										<h1 className="text-40">{customer && customer.payload && customer.payload.length}</h1>
								...
								<Card className="widget mx-8 my-8 flex w-full sm:w-1/2 md:w-1/4 p-12">
									<h1>Orders </h1>
									<span>
										<h1 className="text-40">{order && order.payload && order.payload.length}</h1>
