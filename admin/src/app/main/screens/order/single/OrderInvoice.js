						...
						<div className="flex justify-between">
							<div>
								...
								<Typography color="textSecondary">
									{`${props.order.shippingAddress.firstName} ${props.order.shippingAddress.lastName}`}
								</Typography>

								{props.order.shippingAddress.phone && (
									<Typography color="textSecondary">{props.order.shippingAddress.phone}</Typography>
								)}
								{props.order.shippingAddress.email && (
									<Typography color="textSecondary">{props.order.shippingAddress.email}</Typography>
								)}
							</div>

							<div className={clsx(classes.seller, 'flex items-center p-16')}>
								<img className="w-80" src="assets/images/logos/WMK-Logo.svg" alt="logo" />
								...
								<TableBody>
									{props.order.orderItems.map(product => (
										<TableRow key={product._id}>
											...
											<TableCell align="right">{formatter.format(product.price[0])}</TableCell>
							...
							<Table className="simple mt-32">
								<TableBody>
									...
									<TableRow>
										...
										<TableCell align="right">
											<Typography className="font-light" variant="h4" color="textSecondary">
												{formatter.format(props.order.totalPrice+props.order.taxPrice)}
											</Typography>
										</TableCell>
									</TableRow>
								</TableBody>
						...
						<div className="mt-96">
							...
							<div className="flex">
								<div className="flex-shrink-0">
									<img className="w-32" src="assets/images/logos/makkaj.png" alt="logo" />
								</div>
