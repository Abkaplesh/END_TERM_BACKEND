...
function State(props) {
	...
	const columns = [
		{ id: 'title', label: 'STATE', width: 250 },
		{ id: 'tax_region', label: 'TAX REGION', width: 250 },
		{ id: 'zipCode', label: 'ZIP CODE', width: 120 },
		{ id: 'shipping_charge', label: 'SHIPPING CHARGE', width: 120 },
		{ id: 'state_rate', label: 'STATE RATE', width: 120 },
